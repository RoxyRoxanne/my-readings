...
## imagemagick
  ...
  layout images into a page
    montage *.jpg -tile 2x2 -geometry 1000 all.pdf
      put 2x2 images
      -geometry: size and spacing 
        default: 120x120>+4+3
          fit any image into 120x120
          if image larger shrink it
          but don't resize smaller images (as per >)
        
    montage *.jpg -tile 2x2 -geometry 720x960>+4+3 all2.pdf
    montage *.jpg -tile 1x3 -geometry 960x720>+4+3 all3.pdf
